...
export default function Navbar() {
  ...
  return (
    <nav onClick={() => setIsOpen(false)} className="container">
        ...
        <div className="links flex gap-5">
          {links.map((link) => (
            <Link
              key={link?.path}
              href={link.path}
              className="text-[#21313C] text-sm font-medium cursor-pointer hover:text-green-600 transition-colors"
            >
              {link.element}
            </Link>
          ))}
          ...
          <div className="flex items-center gap-1 lg:gap-2">
            ...
            <div className="flex z-50 relative">
              <button
                ...
                className="cursor-pointer relative p-2.5 rounded-full hover:bg-gray-100 transition-colors group"
                title="Account"
              >
                <svg
                  width={20}
