              ...
              {cartData ? (
                <div className="flex items-center gap-1 lg:gap-2">
                  ...
                  <div className="flex z-50 relative">
                    ...
                    {/* hidden slide  */}
                    {isSmallOpen && (
                      <div onClick={()=>setIsSmallOpen(false)} className="fixed inset-0 bg-black/50 z-40">
                        <div onClick={(e)=>{e.stopPropagation()}} className="fixed lg:hidden top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transition-transform duration-300 overflow-y-auto translate-x-0">
                ...
                <>
                  ...
                  <div className="flex items-center gap-1 lg:gap-2">
                    ...
                    <Link
                      className="bg-[#16A34A] text-white px-5.5 py-3.5 rounded-full text-sm/tight font-semibold flex items-center w-26.75 gap-2 "
                      href="/signin"
                    >
                      <svg
                        width="10.5"
